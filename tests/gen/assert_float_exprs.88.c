...
void test() {
    ...
    assertEqualF64(
        floatexprs88_dot_product_example(&instance, 32000000.0, 1.0, -1.0, 80000000.0, 40000000.0, 1.0, -1.0, -16000000.0),
        2.0,
        "dot_product_example(32000000.0, 1.0, -1.0, 80000000.0, 40000000.0, 1.0, -1.0, -16000000.0)"
    );
    assertEqualF64(
        floatexprs88_with_binary_sum_collapse(&instance, 32000000.0, 1.0, -1.0, 80000000.0, 40000000.0, 1.0, -1.0, -16000000.0),
        2.0,
