...
void test() {
    ...
    assertEqualU32(
        floatexprs77_f32X2Eno_extended_precision_div(&instance, 3.0, 7.0, 0.4285714328289032),
        1u,
        "f32.no_extended_precision_div(3.0, 7.0, 0.4285714328289032)"
    );
    assertEqualU32(
        floatexprs77_f64X2Eno_extended_precision_div(&instance, 3.0, 7.0, 0.42857142857142855),
        1u,
