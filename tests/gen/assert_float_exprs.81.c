...
void test() {
    ...
    assertEqualF32(
        floatexprs81_f32X2EnoX5FfoldX5Fsub1X5FmulX5Fadd(&instance, 2.3283064365386963e-10, 1.0),
        0.0,
        "f32.no_fold_sub1_mul_add(2.3283064365386963e-10, 1.0)"
    );
    assertEqualF64(
        floatexprs81_f64X2EnoX5FfoldX5Fsub1X5FmulX5Fadd(&instance, 5.421010862427522e-20, 1.0),
        0.0,
