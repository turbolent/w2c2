...
void test() {
    ...
    assertEqualF64(
        floatexprs53_thepast0(&instance, 4.450147717014403e-308, 0.9999999999999999, 2.0, 0.5),
        4.4501477170144023e-308,
        "thepast0(4.450147717014403e-308, 0.9999999999999999, 2.0, 0.5)"
    );
    assertEqualF64(
        floatexprs53_thepast1(&instance, 5.551115123125783e-17, 0.9999999999999999, 5.551115123125783e-17),
        -6.162975822039155e-33,
        "thepast1(5.551115123125783e-17, 0.9999999999999999, 5.551115123125783e-17)"
    );
    assertEqualF32(
        floatexprs53_thepast2(&instance, 2.350988701644575e-38, 0.5, 1.0),
