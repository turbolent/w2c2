...
void test() {
    ...
    assertEqualF32(
        m6_funcX2E0Export15_localX2DfirstX2Df32(&instance),
        0.0,
        "local-first-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export15_localX2DfirstX2Df64(&instance),
        0.0,
        "local-first-f64()"
    );
    assertEqualU32(
    ...
    assertEqualF32(
        m6_funcX2E0Export16_localX2DsecondX2Df32(&instance),
        0.0,
        "local-second-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export16_localX2DsecondX2Df64(&instance),
        0.0,
        "local-second-f64()"
    );
    assertEqualF64(
        m6_funcX2E0Export11_localX2Dmixed(&instance),
        0.0,
        "local-mixed()"
    );
    assertEqualU32(
    ...
    assertEqualF32(
        m6_funcX2E0Export15_paramX2DfirstX2Df32(&instance, 2.0, 3.0),
        2.0,
        "param-first-f32(2.0, 3.0)"
    );
    assertEqualF64(
        m6_funcX2E0Export15_paramX2DfirstX2Df64(&instance, 2.0, 3.0),
        2.0,
    ...
    assertEqualF32(
        m6_funcX2E0Export16_paramX2DsecondX2Df32(&instance, 2.0, 3.0),
        3.0,
        "param-second-f32(2.0, 3.0)"
    );
    assertEqualF64(
        m6_funcX2E0Export16_paramX2DsecondX2Df64(&instance, 2.0, 3.0),
        3.0,
        "param-second-f64(2.0, 3.0)"
    );
    assertEqualF64(
        m6_funcX2E0Export11_paramX2Dmixed(&instance, 1.0, 2u, 3ull, 4u, 5.5, 6u),
        5.5,
    ...
    assertEqualF32(
        m6_funcX2E0Export9_valueX2Df32(&instance),
        77.69999694824219,
        "value-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export9_valueX2Df64(&instance),
        77.77,
        "value-f64()"
    );
    ...
    assertEqualF32(
        m6_funcX2E0Export10_returnX2Df32(&instance),
        78.69999694824219,
        "return-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export10_returnX2Df64(&instance),
        78.78,
        "return-f64()"
    );
    assertEqualU32(
    ...
    assertEqualF32(
        m6_funcX2E0Export9_breakX2Df32(&instance),
        79.9000015258789,
        "break-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export9_breakX2Df64(&instance),
        79.79,
        "break-f64()"
    );
    assertEqualU32(
    ...
    assertEqualF32(
        m6_funcX2E0Export14_initX2DlocalX2Df32(&instance),
        0.0,
        "init-local-f32()"
    );
    assertEqualF64(
        m6_funcX2E0Export14_initX2DlocalX2Df64(&instance),
        0.0,
        "init-local-f64()"
    );
}
