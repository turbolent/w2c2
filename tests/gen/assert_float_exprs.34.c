...
void test() {
    ...
    assertEqualF32(
        m14_floatX5FexprsX2E34Export21_f32X2EnoX5FfoldX5Fdiv2X5Fmul2(&instance, 2.3509885615147286e-38),
        2.350988701644575e-38,
        "f32.no_fold_div2_mul2(2.3509885615147286e-38)"
    );
    assertEqualF64(
        m14_floatX5FexprsX2E34Export21_f64X2EnoX5FfoldX5Fdiv2X5Fmul2(&instance, 4.4501477170144023e-308),
